(function () {
    ...
    AlcoholController.$inject = ['$scope', '$state', 'alcoholService', 'Patient'];

    function AlcoholController($scope, $state, alcoholService, Patient) {
        ...
        function createCharts() {
            ...
            vm.lifestyleChart.data = {
                'cols': [
                    {id: 'date', type: 'date'},
                    {id: 'value', label: 'Alcohol Units', type: 'number'}
                ], 'rows': []
            };
