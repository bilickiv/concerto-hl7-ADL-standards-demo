(function () {
    ...
    angular
        .module('alcohol')
        .factory('alcoholService', alcoholService);

    alcoholService.$inject = ['$http', '$log', '$q', '$state', 'constants', 'Patient'];

    function alcoholService($http, $log, $q, $state, constants, Patient) {
