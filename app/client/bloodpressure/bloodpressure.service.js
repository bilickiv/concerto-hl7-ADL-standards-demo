(function () {
    ...
    angular
        ...
        .factory('bloodpressureService', bloodpressureService);

    bloodpressureService.$inject = ['$http', '$log', '$q', 'constants', 'Patient'];

    function bloodpressureService($http, $log, $q, constants, Patient) {
