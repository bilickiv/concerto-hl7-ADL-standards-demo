(function () {
    ...
    angular
        .module('coffeine')
        .controller('CoffeineController', CoffeineController);

    CoffeineController.$inject = ['$scope', '$state', 'coffeineService', 'Patient'];

    function CoffeineController($scope, $state, coffeineService, Patient) {
        ...
        function createCharts() {
            ...
            vm.lifestyleChart.data = {
                'cols': [
                    {id: 'date', type: 'date'},
                    {id: 'value', label: 'Coffeine', type: 'number'}
                ], 'rows': []
            };
