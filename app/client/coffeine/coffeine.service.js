(function () {
        ...
        angular
            .module('coffeine')
            .factory('coffeineService', coffeineService);

        coffeineService.$inject = ['$http', '$log', '$q', '$state', 'constants', 'Patient'];

        function coffeineService($http, $log, $q, $state, constants, Patient) {
