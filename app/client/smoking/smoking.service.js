(function () {
    ...
    angular
        .module('smoking')
        .factory('smokingService', smokingService);

    smokingService.$inject = ['$http', '$log', '$q', '$state', 'constants', 'Patient'];

    function smokingService($http, $log, $q, $state, constants, Patient) {
